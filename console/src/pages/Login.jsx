    ...
    <>
      ...
      <form onSubmit={submit} aria-label="Sign in to admin console">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "20px" }}>
          <label htmlFor="login-email" style={{ fontFamily: DM, fontSize: "11px", fontWeight: 600, letterSpacing: "0.13em", textTransform: "uppercase", color: "#6f685d" }}>
            Email Address
          </label>
          <input
            ...
            style={inputStyle(focused === "email")} disabled={loading}
          />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "10px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <label htmlFor="login-password" style={{ fontFamily: DM, fontSize: "11px", fontWeight: 600, letterSpacing: "0.13em", textTransform: "uppercase", color: "#6f685d" }}>
              Password
            </label>
          </div>
          <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
            <input
              ...
              style={{ ...inputStyle(focused === "password"), paddingRight: "70px" }}
              disabled={loading}
            />
            <button
              type="button" onClick={() => setShowPwd(v => !v)}
              aria-label={showPwd ? "Hide password" : "Show password"}
              style={{ position: "absolute", right: "14px", background: "none", border: "none", cursor: "pointer", fontFamily: DM, fontSize: "12px", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: BURGUNDY, padding: "6px" }}
            >
              {showPwd ? "Hide" : "Show"}
            </button>
          </div>
        ...
        <div style={{ textAlign: "right", marginBottom: "24px" }}>
          <button
            ...
            style={{ background: "none", border: "none", cursor: "pointer", fontFamily: DM, fontSize: "13px", color: BURGUNDY, fontWeight: 500, padding: 0 }}
          >
            Forgot password?
          </button>
        </div>
        ...
        {error && (
          <div role="alert" style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "20px", padding: "12px 14px", borderRadius: "10px", background: "rgba(122,28,28,0.07)", border: "1px solid rgba(122,28,28,0.18)", fontFamily: DM, fontSize: "13px", color: BURGUNDY }}>
        ...
        <button
          ...
          style={{
            ...
            fontFamily: DM, fontSize: "16px", fontWeight: 600, letterSpacing: "0.01em",
            color: "#faf8f5",
            background: loading ? "rgba(122,28,28,0.6)" : hoverBtn ? "#681717" : BURGUNDY,
            boxShadow: hoverBtn && !loading ? "0 12px 28px -8px rgba(122,28,28,0.55)" : "0 8px 20px -10px rgba(122,28,28,0.45)",
      ...
      <p style={{ fontFamily: DM, fontSize: "13px", lineHeight: 1.55, color: "#9a9388", textAlign: "center", margin: "26px 0 0" }}>
  ...
  if (sent) {
    return (
      <>
        ...
        <button
          onClick={onBack}
          style={{ width: "100%", padding: "15px", borderRadius: "10px", border: `1.5px solid #e3ddd2`, background: "none", cursor: "pointer", fontFamily: DM, fontSize: "15px", fontWeight: 600, color: "#6f685d" }}
        >
          ← Back to sign in
        </button>
      </>
  ...
  return (
    <>
      ...
      <form onSubmit={submit}>
        <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "20px" }}>
          <label htmlFor="reset-email" style={{ fontFamily: DM, fontSize: "11px", fontWeight: 600, letterSpacing: "0.13em", textTransform: "uppercase", color: "#6f685d" }}>
            Email Address
          </label>
          <input
            ...
            style={inputStyle(focused)} disabled={loading}
          />
        </div>
        ...
        <button
          ...
          style={{ width: "100%", padding: "13px", borderRadius: "10px", border: "1.5px solid #e3ddd2", background: "none", cursor: "pointer", fontFamily: DM, fontSize: "14px", color: "#9a9388" }}
        >
          ← Back to sign in
        </button>
      </form>
    ...
    <main style={{
      ...
      >
        <div style={{
          ...
          position: "relative", width: "100%", opacity: 0.93,
        }}>
          {/* Badge */}
          ...
          <div style={{ marginBottom: "34px" }}>
            <span style={{ fontFamily: LORA, fontWeight: 700, fontSize: "22px", letterSpacing: "0.14em", color: "#1a1a1a", display: "block" }}>
              BLACKROCK
            </span>
            <span style={{ fontFamily: DM, fontSize: "12px", color: "#9a9388", letterSpacing: "0.05em", marginTop: "3px", display: "block" }}>
              Restaurant &amp; Lounge
            </span>
          </div>
          ...
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              key={view}
              initial={{ opacity: 0, x: view === "forgot" ? 20 : -20 }}
              animate={{ opacity: 1, x: 0 }}
              exit={{ opacity: 0, x: view === "forgot" ? -20 : 20 }}
