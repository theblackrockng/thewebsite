...
| Hero tagline update | Hero `<h1>` in `Home.jsx` changed to "BLACKROCK is a fine dining restaurant serving continental and national dishes, crafted with care and served with elegance." |
