...
| Hero tagline + sub-paragraph update | Hero `<h1>` changed to fine dining brand statement; sub-paragraph updated; h1 font sizes reduced ~17% across all breakpoints (text-3xl/4xl/6xl/7xl) |
