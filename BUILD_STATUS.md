...
_Last updated: 2026-09-24 (Home hero h1 updated to new brand tagline)_
...
| Hero tagline + sub-paragraph update | Hero `<h1>` changed to fine dining brand statement; sub-paragraph changed to "Whether it's a quiet dinner or a celebration, our menu and our space are built for the moment." |
