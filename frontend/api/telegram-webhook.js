...
// Registers this function as the Telegram webhook. Reached as /api/telegram-setup
// through a vercel.json alias so the endpoint stays within the function limit.
...
module.exports = async function handler(req, res) {
  if (req.query && req.query.action === 'setup') return setupWebhook(req, res);
